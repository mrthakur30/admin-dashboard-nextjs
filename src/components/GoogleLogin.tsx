...
export default function GoogleLogin() {
    ...
    const handleLogin = async () => {
     ...
     return (
        ...
        <button className="flex  justify-center items-center gap-3 bg-white px-3 py-1 rounded-md" onClick={handleLogin}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
               ...
               <span className=" text-slate-400 text-sm font-light">Sign in with Google</span>
        </button> 
     )
